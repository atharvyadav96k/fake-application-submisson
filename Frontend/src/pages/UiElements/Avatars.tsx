...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | AAV - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for AAV - React.js Tailwind CSS Admin Dashboard Template"
      />
