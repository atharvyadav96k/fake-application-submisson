...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | AAV - React.js Admin Dashboard Template"
        description="This is React.js Videos page for AAV - React.js Tailwind CSS Admin Dashboard Template"
      />
